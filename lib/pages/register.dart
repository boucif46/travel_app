                      ...
                      ElevatedButton(
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                           ...
                           // await api.register(_nameController.text, _emailController.text,
                           //_passwordController.text, _confirmPasswordController.text);
                           // Get the instance of AccountCubit
                           // Call getUserAccount and wait for it to complete

                              final accountCubit = BlocProvider.of<AccountCubit>(context);
                              await accountCubit.getUserAccount(
